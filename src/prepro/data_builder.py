...
from transformers import BertTokenizer as HuggingFaceTokenizer
...
class BertData():
    def __init__(self, args, use_huggingface_tokenizer=False):
        self.args = args
        if not use_huggingface_tokenizer:
            self.tokenizer = BertTokenizer.from_pretrained('bert-base-uncased', do_lower_case=True)
        else:
            self.tokenizer = HuggingFaceTokenizer.from_pretrained('bert-base-uncased')
    ...
    def preprocess_curation_corpus(self, src_sents, tgt_sents, do_filter=False):
        """
