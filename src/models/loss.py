...
def abs_loss(generator, symbols, vocab_size, device, train=True, label_smoothing=0.0, vocab=None):
    compute = NMTLossCompute(
        generator, symbols, vocab_size,
        label_smoothing=label_smoothing if train else 0.0, vocab=vocab)
    compute.to(device)
    return compute
...
class NMTLossCompute(LossComputeBase):
    ...
    def __init__(self, generator, symbols, vocab_size,
                 label_smoothing=0.0, vocab=None):
